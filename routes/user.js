...
api.put(
    "/update-user/:id", [md_auth.ensureAuth, md_auth_admin.isAdmin],
...
api.put(
    "/set-authentication/:id", [md_auth.ensureAuth, md_auth_admin.isAdmin],
    UserController.setAuthentication
);
api.post(
    "/save-collaborator", [md_auth.ensureAuth, md_auth_admin.isAdmin],
